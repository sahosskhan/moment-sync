...
const BanTwo = () => {
  ...
  <div className="items-center lg:flex ">
    ...
    <div className="lg:max-w-lg">
        ...
        <p className="mt-3 text-gray-600 dark:text-gray-400">Create clear event timelines, delegate responsibilities, and collaborate with clients and vendors in Calendar view. View and manage your meetings in <span className="text-red-500">Momentsync</span> with a two-way Google Calendar sync.</p>
