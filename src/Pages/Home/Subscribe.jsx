...
const Subscribe = () => {
    ...
    <div className="items-center lg:flex">
        <div className="w-full lg:w-1/2 flex justify-center items-center">
            <div className="lg:max-w-5xl">
                ...
                <div className="flex flex-col justify-center items-center  mt-4 space-y-3 lg:space-y-0 lg:flex-row">
                    ...
                    <button className="w-auto px-5 py-2 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-red-600 rounded-lg  lg:mx-4 hover:bg-gray-500 focus:outline-none focus:bg-red-500">
                        Subscribe
                    </button>
                </div>
            </div>
        ...
        <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
            <img className="w-full h-full max-w-xl rounded-xl" src="https://media.giphy.com/media/ge8hwCCv8VWaKDw5BP/source.gif" alt="email illustration vector art"/>
        </div>
    </div>
</div>
    </>
