...
const BanOne = () => {
 ...
 with <span className="text-red-500 text-4xl ">Momentsync</span>
    ...
    <div className="flex items-center hover:scale-110 scale-100 transition-all duration-300 justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
      <img className="w-full h-full lg:max-w-3xl rounded-lg" src="home-banner/ban-one.webp" alt="" />
    </div>
  </div>
</div>
